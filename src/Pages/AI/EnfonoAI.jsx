    ...
    <div className="enfono-ai-page">
          ...
          <div className="enfono-container">
            <div className="enfono-hero-grid">
              <motion.div initial="hidden" animate="visible" variants={stagger}>
                <motion.div className="e-breadcrumb" variants={fadeUp} style={{ marginBottom: '24px' }}>
                  <Link to="/">Home</Link>
                  <i className="fas fa-chevron-right" />
                  <span>AI-Powered ERP</span>
                </motion.div>
                <motion.div className="enfono-hero-eyebrow" variants={fadeUp}>
                  <i className="fas fa-brain" /> AI & Analytics
                </motion.div>
                <motion.h1 className="enfono-hero-title" variants={fadeUp} custom={0.05}>
                  ERP That Gets<br />
                  <span className="highlight">Smarter Every Day</span>
                </motion.h1>
                <motion.p className="enfono-hero-subtitle" variants={fadeUp} custom={0.1}>
                ...
                <motion.div className="enfono-hero-actions" variants={fadeUp} custom={0.15}>
      ...
      <section className="e-light-section">
        <div className="enfono-container">
          ...
          >
            {features.map(f => (
              <motion.div key={f.title} className="e-service-card" variants={fadeUp}>
      ...
      <section className="e-dark-section">
        <div className="enfono-container">
          ...
          >
            {useCases.map(uc => (
              <motion.div key={uc.industry} className="e-cs-card" variants={fadeUp}>
