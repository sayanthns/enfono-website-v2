    ...
    <div className="enfono-home-2-1">
          ...
          <div className="enfono-container">
            <div className="enfono-hero-grid">
              ...
              >
                ...
                <motion.div className="enfono-hero-actions" variants={fadeUp} custom={0.2}>
      ...
      <section className="e-services-section">
        <div className="enfono-container">
          ...
          >
            {services.map((s) => (
              <motion.div key={s.title} className={`e-service-card${s.isAI ? ' ai-card' : ''}`} variants={fadeUp}>
        ...
        <div className="enfono-container">
          ...
          >
            {(cmsData.testimonials || []).map(t => (
              <motion.div key={t.name} className="e-testimonial-card" variants={fadeUp}>
        ...
        <div className="enfono-container">
          ...
          >
            {(cmsData.media_events || []).map((ev, idx) => (
              <motion.div key={idx} className="e-event-card" variants={fadeUp}>
